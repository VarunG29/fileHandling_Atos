...
#Please add input zip file path here
inputZipFilePath = 'C://Users//LENOVO//Desktop//filehandling//test.zip'
...
with ZipFile(inputZipFilePath, 'r') as zipObj:
   ...
   df_combined['Environment'] = df_combined['Environment'].apply(lambda x: 'Asia Prod' if(x.find("Asia Prod") > -1) else x)
